...
public class UTGUIText : MonoBehaviour
{
   ...
   void Reset()
   {
      ...
      //GetComponent<UnityEngine.UI.Text>().alignment = TextAlignment.Center;
      //GetComponent<UnityEngine.UI.Text>().anchor = TextAnchor.UpperCenter;
   }
   ...
   */
   ...
   void OnDrawGizmos()
   {
     ...
     if (distFromCamPlane < 0)		return;
      ...
      // 출력될 글자를 정해 준다.
      GetComponent<UnityEngine.UI.Text>().text = m_Text;
   }
}
